...
from prompting_sgd_correctionlm import get_zeroshot_correction_prompt
...
parser.add_argument('--model_path', type=str, default='', help="file to evaluate on, empty means use the test set")
